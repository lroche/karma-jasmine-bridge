;(function(global) {
    ...
    var jasmineBridge = new JasmineBridge(),
        originalCreateSpy = jasmineBridge.getCreateSpyFn(global);
    ...
    jasmineBridge.decorate(global, 'createSpy', function(name, fn){   
    ...
    global['jasmine'].Clock.tick = function(millis){
